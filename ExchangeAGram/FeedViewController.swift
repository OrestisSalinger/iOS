...
//    var managedObjectContext: NSManagedObjectContext = NSManagedObjectContext()
    ...
    */
    ...
    @IBAction func snapBarItemTapped(sender: UIBarButtonItem) {
        ...
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.Camera){
            ...
            var alertView = UIAlertController(title: "Alert", message: "Your device does not support camera or photo library access", preferredStyle: UIAlertControllerStyle.Alert)
